...
if (isset($_GET['id_event'])) {
    ...
    // buat query hapus
    $sql = "SELECT * FROM SIM_TAMBAH_EVENT Where id_event=$id";
...
<head>
    ...
    <title>Edit Event SISTEM INFORMASI MASJID</title>
    <!-- Favicon-->
                        ...
                        <form method="post" action="../../controller/api-edit-user.php">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    value="<?php echo $user['nama_masjid']?>">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    value="<?php echo $user['pengelola_event']?>">
                                    <label class="form-label">Pengelola Masjid</label>
                                </div>
                            </div>

                            <h2 class="card-inside-title">Kategori Event</h2>
                            <small>Sesuakan kategori yang dipilih</small>
                            <!--                            <div class="body">-->
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <select class="form-control show-tick" name="kategori_event" data-to="<?php echo $user['kategori_event']?>">
...
<!--                            </div>-->
                            ...
                            <small>Sesuakan kota yang dipilih</small>

                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <select class="form-control show-tick" name="kota_event" data-to="<?php echo $user['kota_event']?>">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="alamat_event" class="form-control" name="alamat_event" value="<?php echo $user['alamat_event']?>">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control" name="waktu_mulai_event"
                                                   value="<?php echo $user['waktu_mulai_event']?>"
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control" name="waktu_selesai_event"
                                                   value="<?php echo $user['waktu_selesai_event']?>"
...
<!--                            </div>-->
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    value="<?php echo $user['kuota_event']?>">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    value="<?php echo $user['deskripsi_event']?>">
...
<!--                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">-->
                                <button class="btn btn-primary m-t-15 waves-effect" name="edit_event">Edit Event !
                                </button>
<!--                            </div>-->
