...
if (isset($_GET['id_user'])) {
    ...
    // buat query hapus
    $sql = "SELECT * FROM SIM_USER Where id_user=$id";
...
//     echo "<td>".$siswa['rule']."</td>";
//     echo "<td>".$siswa['username']."</td>";
//     echo "<td>".$siswa['status']."</td><br>";

//     echo "<td>";
//     echo "<a href='../../controller/edit.php?id_user=".$siswa['id_user']."'>Edit</a> | ";
//     echo "<a href='../../controller/api-delete.php?id_user=".$siswa['id_user']."'>Hapus | </a>";
//     echo "<a href='../../controller/api-aprovel.php?id_user=".$siswa['id_user']."'>Aprove</a>";
//     echo "</td>";
...
<head>
    ...
    <title>Edit User SISTEM INFORMASI MASJID</title>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active">
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="tambah-data-user.php">Tambah Data</a>
                        </li>
                        <!--  <li class="active">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Edit Data User Aktif
                            <small>*Sesuaikan data yang telah diberikan dari pihak Masjid</small>
                        </h2>
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
...
<!--                                    </div>-->
                                    ...
                                    <div class="demo-radio-button">
                                        <input name="jk" type="radio" id="radio_1" checked/>
                                        <label for="radio_1">Laki - Laki</label>
                                        <input name="jk" type="radio" id="radio_2"/>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Nama Masjid"
                                                   name="nama_masjid"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <button class="btn btn-primary btn-lg m-l-15 waves-effect" name="update_user" >Edit
                                </button>
                            </div>
                        </div>
                        </form>
