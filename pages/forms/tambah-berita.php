...
<head>
    ...
    <title>Tambah Berita SISTEM INFORMASI MASJID</title>
    <!-- Favicon-->
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="post" action="../../controller/api-uploadgambar.php" enctype="multipart/form-data">
                            ...
                            <small>- Gambar tidak dapat diubah setelah melalukan Publish Berita !</small><br>
                            <small>- Gambar yang harus ber-extensi .png dan kurang dari 5Mb</small>
...
<!--                                </form>-->
                            ...
                            <br>
                                <button class="btn btn-primary m-t-15 waves-effect" name="tambah_berita" type="submit">Publish Berita !
                                </button>
