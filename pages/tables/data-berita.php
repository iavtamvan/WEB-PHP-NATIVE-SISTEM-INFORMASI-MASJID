...
<body class="theme-red">
    ...
    <section class="content">
            ...
            <div class="row clearfix">
                ...
                <br>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                 <a href="../forms/tambah-berita.php">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <h2 align="center" >Tambah Berita Baru</h2>
                            <!-- <div class="text"></div> -->
                        </div>
                    </div>
                </a>
        ...
        session_status();
        $session_id = $_SESSION['id_user'];
        $sql = "SELECT * FROM SIM_BERITA ORDER by jam_berita ASC";
        $query = mysqli_query($db, $sql);

        while($siswa = mysqli_fetch_array($query)){
            echo "<tr>";

            echo "<td>".$siswa['id_berita']."</td>";
            echo "<td>".$siswa['nama_pembuat_berita']."</td>";
            echo "<td>".$siswa['judul_berita']."</td>";
            echo "<td>".$siswa['tgl_berita']."</td>";
            echo "<td>".$siswa['deskripsi_berita']."</td>";
            echo "<td>".$siswa['jam_berita']."</td>";
            echo "<td>".$siswa['image_berita']."</td>";
            echo "<td><b><font color='#ff4500'>".$siswa['status_berita']."</font></b></td>";
            ...
            echo "<a href='../../controller/api-aprovel.php?id_berita=".$siswa['id_berita']."'>Aprove</a>";
            echo "</td>";
