            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="../forms/tambah-data-user.php">Tambah Data User</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="data-user.php">Data User Aktif</a>
                            </li>
                            <li>
                                <a href="data-berita.php">Data Berita</a>
                            </li>
                            <li>
                                <a href="data-event.php">Data Event</a>
                            </li>
                            <!--<li>
                ...
                <br>
                    ...
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <h2 align="center">Tambah Data Event</h2>
                            <!-- <div class="text"></div> -->
                        </div>
                    </div>
                </a>
                ...
                <br>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
        <?php
        $sql = "SELECT * FROM SIM_TAMBAH_EVENT ORDER BY status_event ASC, id_event ASC";
        $query = mysqli_query($db, $sql);

        while($siswa = mysqli_fetch_array($query)){
            echo "<tr>";

            echo "<td>".$siswa['id_event']."</td>";
            echo "<td>".$siswa['judul_event']."</td>";
            echo "<td>".$siswa['nama_masjid']."</td>";
            echo "<td>".$siswa['pengelola_event']."</td>";
            echo "<td>".$siswa['kategori_event']."</td>";
            echo "<td>".$siswa['tgl_event']."</td>";
            echo "<td>".$siswa['waktu_mulai_event']."-".$siswa['waktu_selesai_event']."</td>";
            echo "<td>".$siswa['kota_event']."</td>";
            echo "<td>".$siswa['alamat_event']."</td>";
            echo "<td>".$siswa['kuota_event']."</td>";
            echo "<td>".$siswa['deskripsi_event']."</td>";
            echo "<td>".$siswa['status_event']."</td>";

            echo "<td>";
            echo "<a href='../../pages/forms/edit-event.php?id_event=".$siswa['id_event']."'>Edit</a> | ";
            echo "<a href='../../controller/api-delete.php?id_event=".$siswa['id_event']."'>Hapus | </a>";
            echo "<a href='../../controller/api-aprovel.php?id_event=".$siswa['id_event']."'>Aprove</a>";
            echo "</td>";
