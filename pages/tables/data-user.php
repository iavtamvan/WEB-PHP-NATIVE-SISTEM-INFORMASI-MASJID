...
<body class="theme-red">
    ...
    <section class="content">
            ...
            <div class="row clearfix">
                ...
                <br>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                 <a href="../forms/tambah-data-user.php">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <h2 align="center">Tambah Data User Actived</h2>
                            <!-- <div class="text"></div> -->
                        </div>
                    </div>
                </a>
                ...
                <br>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
        <?php
        $sql = "SELECT * FROM SIM_USER Where rule='user' ORDER BY status ASC ";
        $query = mysqli_query($db, $sql);
        ...
        while($siswa = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a href='../../pages/forms/edit-user.php?id_user=".$siswa['id_user']."'>Edit</a> | ";
